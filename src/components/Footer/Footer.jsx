    ...
    <footer className="footer">
      <div className="footer-cta">
        <div className="footer-cta-content">
          <span className="footer-cta-badge">📖 Akademik Yayın Platformu</span>
          <h2>Bir fikriniz varsa, onu dünyayla paylaşın.</h2>
          <p>
            Araştırmalarınızı, makalelerinizi ve özgün çalışmalarınızı bağımsız
            akademik topluluğumuzla buluşturun.
          </p>
        </div>

        <div className="footer-cta-actions">
          <a href="/submit" className="footer-cta-primary">
            Makale Gönder
          </a>
          <a href="/about" className="footer-cta-secondary">
            Daha Fazla Bilgi
          </a>
        </div>
      </div>
      ...
      <div className="container footer-container">
        <div className="footer-grid">
          <div className="footer-brand-column">
            <a href="/" className="footer-brand" aria-label="Giyotinin Eşiğinde ana sayfa">
              <img
                src={currentLogo}
              ...
              <div>
                ...
                <p className="footer-slogan">Fikirler yargılanır, insanlar değil.</p>
              </div>
            </a>
        ...
        <div className="footer-bottom">
          <span>© 2026 Giyotinin Eşiğinde. Tüm hakları saklıdır.</span>
